...
//  textDemo
//
//  Created by ARTOONMM0024 on 06/09/21.
//
...
class ViewController: UIViewController, AVCaptureVideoDataOutputSampleBufferDelegate, AVCaptureMetadataOutputObjectsDelegate {
    ...
    private lazy var previewLayer: AVCaptureVideoPreviewLayer = {
        ...
        preview.insertSublayer(cardLayer, above: preview)
        let cardWidth = 350.0 as CGFloat
        let cardHeight = 100 as CGFloat
...
class ViewController1: UIViewController, CCScannerDelegate {
